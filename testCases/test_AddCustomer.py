...
class Test_003_AddCustomer:
    ...
    def test_AddCustomer(self, setup):  ### here we use setup from conftest.py
        ...
        self.lp = LoginPage(self.driver) ### create object for loginPage, LP has one constructor
        ...
        self.addcust = AddCustomer(self.driver)  ### creating an object / has one constractor
